...
def get_params():
    params = {
        'weight': r'E:\pythonproject\ultralytics-yolo11-20250215\ultralytics-yolo11-main\runs\train\NEU-DET(LightSDD)\weights\best.pt',  # 训练出来的权重文件
        'cfg': r'E:\pythonproject/ultralytics-yolo11-20250215/ultralytics-yolo11-main/ultralytics/cfg/models/11/yolo11-LSCD+PKI.yaml',  # 训练权重对应的yaml配置文件
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'E:\pythonproject\ultralytics-yolo11-20250215\ultralytics-yolo11-main\heatmaps\NEU-DET val images', 'E:\pythonproject/ultralytics-yolo11-20250215/ultralytics-yolo11-main/resultss/单层1LightSDD')  # 第一个是检测的文件, 第二个是保存的路径